...
/**
 * Strings for component 'local_pdi', language 'en'
 *
 * @package   local_pdi
 * @license   http://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
 
$string['plugintitle'] = 'IDP Moodle Plugin (PDI)';
$string['options'] = 'Options:';
$string['idp_plugin'] = 'IDP Plugin';
$string['web_adm_all_set'] = 'You have already setup the plugin, click in manage to modify the plugin users :)';
$string['web_adm_not_set'] = 'Hi, moodle admin! It seems like you have not added any plugin admins yet.';
