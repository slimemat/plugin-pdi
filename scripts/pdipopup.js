...
dragElement(document.getElementById("div-popup"));
...
//reset
var clicker = 0;
document.getElementById("pdi-logo-span").onclick = function() {

    switch (clicker) {
        case 0:
            document.getElementById("div-popup").style.left = "20px";
            document.getElementById("div-popup").style.right = "auto";
            clicker = 1;
            break;

        case 1:
            document.getElementById("div-popup").style.right = "20px";
            document.getElementById("div-popup").style.left = "auto";
            clicker = 0;
            break;
